        ...
        <React.Fragment>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <TextField required id="firstName" name="firstName" label="Nombres" fullWidth autoComplete="given-name" variant="standard" />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField required id="lastName" name="lastName" label="Apellidos" fullWidth autoComplete="family-name" variant="standard" />
            </Grid>
            <Grid item xs={12}>
              <TextField required id="identity" name="identity" label="Identificación" fullWidth variant="standard" />
            </Grid>
            <Grid item xs={12}>
              <TextField id="address" name="address" label="Dirección" fullWidth variant="standard" />
            </Grid>
            <Box sx={{ minWidth: 120, mt: 4, ml: 3 }}>
              <FormControl fullWidth>
                ...
                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={etnia} label="etnia" onChange={handleEtniaChange}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
            ...
            <Box>
              <Button variant="contained" sx={{ mt: 3, ml: 1 }} className="text-black bg-blue-500 hover:bg-blue-600">
                Aceptar
              </Button>
